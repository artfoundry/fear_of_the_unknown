...
class UI {
    ...
    openHelpPopup(params) {
        let $popup = $('<div class="popup"><div class="popup-content">' + params.content + '</div></div>'),
        ...
        $('#app').append($popup);
        this.events.setUpGeneralInteractionListeners('body', this.closeHelpPopup.bind(this));
    }

    closeHelpPopup() {
        $('popup').remove();
        this.events.removeClickListener('body');
    }
